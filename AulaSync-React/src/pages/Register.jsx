  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="relative hidden w-0 flex-1 lg:block">
        <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-green-600 to-green-400">
          <div className="flex h-full flex-col items-center justify-center p-12 text-white">
            ...
            <p className="mt-4 max-w-md text-center text-lg text-green-100">
              Comienza tu viaje educativo con nosotros. Accede a tus clases, tareas y calificaciones en un solo lugar.
            </p>
          </div>
        </div>
      </div>
