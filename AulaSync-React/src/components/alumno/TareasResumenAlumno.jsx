...
const TareasResumenAlumno = ({ tareas = [] }) => {
    ...
    const renderTareaModal = () => {
        ...
        useEffect(() => {
            if (showTareaModal && tareaSeleccionada) {
        ...
        const downloadUrl = entregaFinal.archivoUrl
                                                ...
                                                <div className="flex flex-col gap-4 items-center justify-center py-8 px-4 bg-red-50 border border-red-200 rounded-xl">
                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <p className="text-red-600">
                                                            La fecha límite expiró hace {getTimeAgo(tareaSeleccionada.fechaEntrega)}
                                                        </p>
                                                ...
                                                if (isCalificada) {
                                                    ...
                                                    return (
                                                        <span className="flex items-center gap-2 px-3 py-1.5 bg-red-50 text-red-700 text-xs font-medium rounded-full border border-red-200">
                                                            ...
                                                            Expiró hace {getTimeAgo(tarea.fechaEntrega)}
                                                        </span>
                                                    );
                                                } else {
                                                    return (
