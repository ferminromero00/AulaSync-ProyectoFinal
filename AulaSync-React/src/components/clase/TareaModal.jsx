...
const TareaModal = ({ 
    ...
    // Solo hacer fetch de entregas si eres profesor (para estadísticas o similares)
    useEffect(() => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl w-full max-w-6xl mx-4 flex flex-col md:flex-row relative shadow-2xl max-h-[90vh] overflow-hidden">
                {/* Botón de cerrar */}
                <button
                    onClick={onClose}
