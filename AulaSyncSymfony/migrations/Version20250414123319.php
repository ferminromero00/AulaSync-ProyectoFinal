 ...
 */
final class Version20250414123319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE clase (id INT AUTO_INCREMENT NOT NULL, profesor_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, num_estudiantes INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_199FACCEE52BD977 (profesor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
